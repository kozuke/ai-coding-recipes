...
export default async function TipPage({ params }: Props) {
  ...
  if (!tip) {
    return (
      <div className="py-8">
        <h2 className="text-3xl font-bold mb-6 dark:text-gray-100">Tipが見つかりませんでした</h2>
  ...
  return (
    <div className="py-8">
      ...
      <article className="max-w-none">
        <h1 className="text-3xl font-bold mb-4 dark:text-gray-100">{tip.title}</h1>
