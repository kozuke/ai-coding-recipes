  ...
  return (
    <div className="py-8">
      ...
      <article className="max-w-none">
        ...
        <div 
          className="mt-6 prose dark:prose-invert prose-indigo prose-p:text-gray-600 dark:prose-p:text-gray-300 prose-headings:text-gray-700 dark:prose-headings:text-gray-200 prose-a:text-blue-500 dark:prose-a:text-blue-400 prose-code:bg-blue-50 dark:prose-code:bg-gray-800 prose-pre:bg-gray-50 dark:prose-pre:bg-gray-800 max-w-none"
